...
3. Res_Trans_Downscael.py: Downscale N manure from 10 km to 0.5 degree
4. Cal_PN_ratio.py: Calculate PN ratio using the N, P content in manure data
5. Format_Trans_tif2nc.py: Transform the calculated PN ratio data from .tiff to .nc data (0.5 degree)
