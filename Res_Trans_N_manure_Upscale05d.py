...
# 3. Calculate the total amount of manure input for each pixel at 0.05 degree (harvest area * N fertilization rate)
...
# Loop through each key in the HDF5 file
    for key in h5file.keys():
        # Extract the dataset associated with the key
        data = h5file[key][:]
        ...
        with Dataset(output_nc_file, 'w', format='NETCDF4') as ncfile:
            ...
            time_var.units = 'Year'  # Customize as needed
...
HA_005d_path = 'C:/Users/zhou111/OneDrive - Wageningen University & Research/2_Data/NP_Input/Processed_data/HA_005d'
...
# Output path:
N_manure_005d_path = 'C:/Users/zhou111/OneDrive - Wageningen University & Research/2_Data/NP_Input/Processed_data/N_Manure_005d'
N_manure_05d_path = 'C:/Users/zhou111/OneDrive - Wageningen University & Research/2_Data/NP_Input/Processed_data/N_Manure_05d'
...
Manure_005d_path = 'C:/Users/zhou111/OneDrive - Wageningen University & Research/2_Data/NP_Input/Processed_data/N_Manure_Input_Original'
...
for crop in crop_namelist:
    HA_005d = os.path.join(HA_005d_path, f"{crop}.nc")
    Manure_005d = os.path.join(Manure_005d_path, f"N_application_rate_{crop}_1961-2020.nc")
    
    nc_HA = xr.open_dataset(HA_005d)    
    data_HA = nc_HA['HA'][:]
    
    nc_file = xr.open_dataset(Manure_005d)    
    ...
    # Calculate the total amount of N manure input of the harvest area within a 0.05 degree pixel
...
# 4. Sum up the total N manure input amount at the 0.5 degree resolution
    ...
    output_N_manure_amount_005d = os.path.join(N_manure_005d_path, f"N_manure_input_amount_{crop}_1961-2020.nc") 
    output_N_manure_amount_05d = os.path.join(N_manure_05d_path, f"N_manure_input_amount_{crop}_1961-2020.nc")
    
    b.to_netcdf(output_N_manure_amount_005d)
